...
export default function ContactUs() {
  ...
  return (
    <section className="bg-background relative w-full overflow-hidden py-16 md:py-24">
      {/* Green glowing background bubbles */}
      <div
        className="absolute top-0 left-0 h-[500px] w-[500px] rounded-full opacity-20 blur-[120px]"
        style={{
          background: `radial-gradient(circle at center, #00c776, transparent 70%)`,
        }}
      />
      <div
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="relative p-6 md:p-10" ref={formRef}>
              ...
              >
                ...
                <span className="text-green-600 relative z-10 w-full text-4xl font-bold tracking-tight italic md:text-5xl">
                  Us
                </span>
                <SparklesCore
                  id="tsparticles"
              ...
              >
                ...
                >
                  <Button
                    ...
                    className="w-full bg-gradient-to-b from-green-500 to-green-700 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]"
                  >
                    {isSubmitting ? (
            ...
            >
              <div className="flex flex-col items-center justify-center overflow-hidden">
                <article className="relative mx-auto h-[350px] min-h-60 max-w-[450px] overflow-hidden rounded-3xl border bg-gradient-to-b from-[#00c776] to-[#00c776]/5 p-6 text-3xl tracking-tight text-white md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
                  Powering your world with clean, sustainable energy.
